export const getSignInEmailTemplate = (otp: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sign in to Quick Note</title>
</head>
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; border: 0; border-spacing: 0;">
                <tr>
                  <td align="center" style="padding: 0;">
                    ...
                    <h1 style="margin: 0 0 12px 0; font-size: 26px; line-height: 32px; font-weight: 800; color: #111827; letter-spacing: -0.025em;">Welcome back</h1>
                    
                    <p style="margin: 0 0 40px 0; font-size: 16px; line-height: 24px; color: #4b5563;">
                      Please use the following one-time password (OTP) to sign in to your Quick Note account. If you don't have an account, this will create one for you.
                    </p>
                      ...
                      <tr>
                        <td style="padding: 24px; background-color: #f9fafb; border-radius: 12px; border: 1px solid #f3f4f6;">
                          ...
                          <ul style="margin: 0; padding: 0 0 0 20px; font-size: 13px; line-height: 18px; color: #6b7280;">
                            ...
                            <li>If you didn't request a sign in, you can safely ignore this email.</li>
                          </ul>
                        </td>
                      </tr>
                    </table>
