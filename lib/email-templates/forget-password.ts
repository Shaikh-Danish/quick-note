export const getForgetPasswordTemplate = (otp: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; border: 0; border-spacing: 0;">
                <tr>
                  <td align="center" style="padding: 0;">
                    ...
                    <h1 style="margin: 0 0 12px 0; font-size: 26px; line-height: 32px; font-weight: 800; color: #111827; letter-spacing: -0.025em;">Reset your password</h1>
                    
                    <p style="margin: 0 0 40px 0; font-size: 16px; line-height: 24px; color: #4b5563;">
                      We received a request to reset the password for your Quick Note account. Please use the following one-time password (OTP) to proceed.
                    </p>
